...
import { fetchMyDailyReportsList } from '@/services/daily-reports.service';
import { myReportColumns } from '../_components/report-columns';
...
export default function MyReportsPage() {
  ...
  const { data, isLoading } = useQuery({
    queryKey: ['my-daily-reports', filters.page, filters.limit, filters.date],
    queryFn: () => fetchMyDailyReportsList(filters),
  });
